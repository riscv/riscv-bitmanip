...
????-??-?? & 0.35 & Replace {\tt shuffle} with generalized zip ({\tt gzip})\tabularnewline
           &      & Add additional XBitfield ISA Extension\tabularnewline
           &      & Add figures and tables, Clean up document\tabularnewline
           &      & Add Verilog reference implementations\tabularnewline
           &      & Add fast C reference implementations\tabularnewline
\bottomrule
\end{longtable}
