...
often are not fast outperform algortihms that use sequences of shifts and bit
masks.
...
longer sequence of simpler operations.
...
Beneš network. For example on RV32:
...
implements a single stage of an omega network.
