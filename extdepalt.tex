...
0010 & {\it reserved, fwd/rev baseline stage (?)}  & --- \\
0011 & {\it reserved, fwd/rev baseline stage (?)}  & --- \\
0100 & {\it reserved, fwd/rev baseline stage (?)}  & --- \\
0101 & {\it reserved, fwd/rev baseline stage (?)}  & --- \\
0110 & {\it reserved, fwd/rev baseline stage (?)}  & --- \\
0111 & {\it reserved, fwd/rev baseline stage (?)}  & --- \\
