...
0001 & {\it baseline network stage (?)}            & --- \\
0010 & {\it baseline network stage (?)}            & --- \\
0011 & {\it baseline network stage (?)}            & --- \\
0100 & {\it baseline network stage (?)}            & --- \\
0101 & {\it baseline network stage (?)}            & --- \\
0110 & {\it baseline network stage (?)}            & --- \\
0111 & butterfly(mask, 0) + unzip                  & {\tt flip, unzip} \\
