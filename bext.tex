...
\texttt{pcnt} is encoded as a standard I-type opcode.
...
\subsection{Implementation Commentary}
...
all implementations that supports the C extension and XBitmanip.

\subsection{Encoding}

\input{bextcompr}

This four instructions fit nicely in the reserved space in C.LUI. They only occupy $0.13\%$
of the $\approx15.6$ bits wide RVC encoding space.
