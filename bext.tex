...
If possible, an implementation should fuse this two shift operations in a single
...
not support compressed instructions. See Chapter~\ref{bfxp} if you are one of
those people.

\subsection{Pseudo instructions using {\tt grevi} and {\tt gzip}}
...
See Section~\ref{gzip} for the list of pseudo-instructions using {\tt gzip}.
