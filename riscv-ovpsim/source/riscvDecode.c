...
const static opAttrs attrsArray32[] = {
    ...
    ATTR32_VV        (       VSEQ_VV,        VSEQ_VR, RVANYV, "vseq",          "|011000|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSNE_VV,        VSNE_VR, RVANYV, "vsne",          "|011001|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VSLTU_VV,       VSLTU_VR, RVANYV, "vsltu",         "|011010|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSLT_VV,        VSLT_VR, RVANYV, "vslt",          "|011011|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VSLEU_VV,       VSLEU_VR, RVANYV, "vsleu",         "|011100|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSLE_VV,        VSLE_VR, RVANYV, "vsle",          "|011101|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VSGTU_VV,       VSGTU_VR, RVANYV, "vsgtu",         "|011110|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSGT_VV,        VSGT_VR, RVANYV, "vsgt",          "|011111|.|.....|.....|000|.....|1010111|"),
    ...
    ATTR32_VX        (       VSEQ_VX,        VSEQ_VR, RVANYV, "vseq",          "|011000|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSNE_VX,        VSNE_VR, RVANYV, "vsne",          "|011001|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VSLTU_VX,       VSLTU_VR, RVANYV, "vsltu",         "|011010|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSLT_VX,        VSLT_VR, RVANYV, "vslt",          "|011011|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VSLEU_VX,       VSLEU_VR, RVANYV, "vsleu",         "|011100|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSLE_VX,        VSLE_VR, RVANYV, "vsle",          "|011101|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VSGTU_VX,       VSGTU_VR, RVANYV, "vsgtu",         "|011110|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSGT_VX,        VSGT_VR, RVANYV, "vsgt",          "|011111|.|.....|.....|100|.....|1010111|"),
