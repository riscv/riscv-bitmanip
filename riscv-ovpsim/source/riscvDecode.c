...
typedef struct opAttrsS {
    ...
    riscvVIType       VIType   :  4;    // vector instruction type
...
const static opAttrs attrsArray32[] = {
    ...
    ATTR32_VV        (       VADD_VV,        VADD_VV, RVANYV, "vadd",          "|000000|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSUB_VV,        VSUB_VV, RVANYV, "vsub",          "|000010|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VMINU_VV,       VMINU_VV, RVANYV, "vminu",         "|000100|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VMIN_VV,        VMIN_VV, RVANYV, "vmin",          "|000101|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VMAXU_VV,       VMAXU_VV, RVANYV, "vmaxu",         "|000110|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VMAX_VV,        VMAX_VV, RVANYV, "vmax",          "|000111|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VAND_VV,        VAND_VV, RVANYV, "vand",          "|001001|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (        VOR_VV,         VOR_VV, RVANYV, "vor",           "|001010|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VXOR_VV,        VXOR_VV, RVANYV, "vxor",          "|001011|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (   VRGATHER_VV,    VRGATHER_VV, RVANYV, "vrgather",      "|001100|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VADC_VV,        VADC_VV, RVANYV, "vadc",          "|010000|1|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSBC_VV,        VSBC_VV, RVANYV, "vsbc",          "|010010|1|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (    VMERGEM_VV,      VMERGE_VV, RVANYV, "vmerge",        "|010111|0|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (    VMERGE0_VV,      VMERGE_VV, RVANYV, "vmerge",        "|010111|1|00000|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSEQ_VV,        VSEQ_VV, RVANYV, "vseq",          "|011000|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSNE_VV,        VSNE_VV, RVANYV, "vsne",          "|011001|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VSLTU_VV,       VSLTU_VV, RVANYV, "vsltu",         "|011010|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSLT_VV,        VSLT_VV, RVANYV, "vslt",          "|011011|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VSLEU_VV,       VSLEU_VV, RVANYV, "vsleu",         "|011100|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSLE_VV,        VSLE_VV, RVANYV, "vsle",          "|011101|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VSGTU_VV,       VSGTU_VV, RVANYV, "vsgtu",         "|011110|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSGT_VV,        VSGT_VV, RVANYV, "vsgt",          "|011111|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (     VSADDU_VV,      VSADDU_VV, RVANYV, "vsaddu",        "|100000|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VSADD_VV,       VSADD_VV, RVANYV, "vsadd",         "|100001|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (     VSSUBU_VV,      VSSUBU_VV, RVANYV, "vssubu",        "|100010|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VSSUB_VV,       VSSUB_VV, RVANYV, "vssub",         "|100011|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VAADD_VV,       VAADD_VV, RVANYV, "vaadd",         "|100100|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSLL_VV,        VSLL_VV, RVANYV, "vsll",          "|100101|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VASUB_VV,       VASUB_VV, RVANYV, "vasub",         "|100110|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VSMUL_VV,       VSMUL_VV, RVANYV, "vsmul",         "|100111|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSRL_VV,        VSRL_VV, RVANYV, "vsrl",          "|101000|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (       VSRA_VV,        VSRA_VV, RVANYV, "vsra",          "|101001|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VSSRL_VV,       VSSRL_VV, RVANYV, "vssrl",         "|101010|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VSSRA_VV,       VSSRA_VV, RVANYV, "vssra",         "|101011|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VNSRL_VV,       VNSRL_VV, RVANYV, "vnsrl",         "|101100|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (      VNSRA_VV,       VNSRA_VV, RVANYV, "vnsra",         "|101101|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (    VNCLIPU_VV,     VNCLIPU_VV, RVANYV, "vnclipu",       "|101110|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (     VNCLIP_VV,      VNCLIP_VV, RVANYV, "vnclip",        "|101111|.|.....|.....|000|.....|1010111|"),
    ...
    ATTR32_VV        (   VWSMACCU_VV,    VWSMACCU_VV, RVANYV, "vwsmaccu",      "|111100|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (    VWSMACC_VV,     VWSMACC_VV, RVANYV, "vwsmacc",       "|111101|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (   VWSMSCCU_VV,    VWSMSCCU_VV, RVANYV, "vwsmsccu",      "|111110|.|.....|.....|000|.....|1010111|"),
    ATTR32_VV        (    VWSMSCC_VV,     VWSMSCC_VV, RVANYV, "vwsmscc",       "|111111|.|.....|.....|000|.....|1010111|"),

    // V-extension FVV-type instructions                                        |funct6|m|  vs2|  vs1|FVV|  vs3| opcode|
    ATTR32_VV        (      VFADD_VV,       VFADD_VV, RVANYV, "vfadd",         "|000000|.|.....|.....|001|.....|1010111|"),
    ATTR32_VS        (   VFREDSUM_VS,    VFREDSUM_VS, RVANYV, "vfredsum",      "|000001|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (      VFSUB_VV,       VFSUB_VV, RVANYV, "vfsub",         "|000010|.|.....|.....|001|.....|1010111|"),
    ATTR32_VS        (  VFREDOSUM_VS,   VFREDOSUM_VS, RVANYV, "vfredosum",     "|000011|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (      VFMIN_VV,       VFMIN_VV, RVANYV, "vfmin",         "|000100|.|.....|.....|001|.....|1010111|"),
    ATTR32_VS        (   VFREDMIN_VS,    VFREDMIN_VS, RVANYV, "vfredmin",      "|000101|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (      VFMAX_VV,       VFMAX_VV, RVANYV, "vfmax",         "|000110|.|.....|.....|001|.....|1010111|"),
    ATTR32_VS        (   VFREDMAX_VS,    VFREDMAX_VS, RVANYV, "vfredmax",      "|000111|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (     VFSGNJ_VV,      VFSGNJ_VV, RVANYV, "vfsgnj",        "|001000|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (    VFSGNJN_VV,     VFSGNJN_VV, RVANYV, "vfsgnjn",       "|001001|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (    VFSGNJX_VV,     VFSGNJX_VV, RVANYV, "vfsgnjx",       "|001010|.|.....|.....|001|.....|1010111|"),
    ATTR32_VFMV_F_S  (      VFMV_F_S,       VFMV_F_S, RVANYV, "vfmv.f.s",      "|001100|.|.....|00000|001|.....|1010111|"),
    ATTR32_VV        (       VFEQ_VV,        VFEQ_VV, RVANYV, "vfeq",          "|011000|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (      VFLTE_VV,       VFLTE_VV, RVANYV, "vflte",         "|011001|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (      VFORD_VV,       VFORD_VV, RVANYV, "vford",         "|011010|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (       VFLT_VV,        VFLT_VV, RVANYV, "vflt",          "|011011|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (       VFNE_VV,        VFNE_VV, RVANYV, "vfne",          "|011100|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (      VFDIV_VV,       VFDIV_VV, RVANYV, "vfdiv",         "|100000|.|.....|.....|001|.....|1010111|"),
    ...
    ATTR32_VV        (      VFMUL_VV,       VFMUL_VV, RVANYV, "vfmul",         "|100100|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (     VFMADD_VV,      VFMADD_VV, RVANYV, "vfmadd",        "|101000|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (    VFNMADD_VV,     VFNMADD_VV, RVANYV, "vfnmadd",       "|101001|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (     VFMSUB_VV,      VFMSUB_VV, RVANYV, "vfmsub",        "|101010|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (    VFNMSUB_VV,     VFNMSUB_VV, RVANYV, "vfnmsub",       "|101011|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (     VFMACC_VV,      VFMACC_VV, RVANYV, "vfmacc",        "|101100|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (    VFNMACC_VV,     VFNMACC_VV, RVANYV, "vfnmacc",       "|101101|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (     VFMSAC_VV,      VFMSAC_VV, RVANYV, "vfmsac",        "|101110|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (    VFNMSAC_VV,     VFNMSAC_VV, RVANYV, "vfnmsac",       "|101111|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (     VFWADD_VV,      VFWADD_VV, RVANYV, "vfwadd",        "|110000|.|.....|.....|001|.....|1010111|"),
    ATTR32_VS        (  VFWREDSUM_VS,   VFWREDSUM_VS, RVANYV, "vfwredsum",     "|110001|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (     VFWSUB_VV,      VFWSUB_VV, RVANYV, "vfwsub",        "|110010|.|.....|.....|001|.....|1010111|"),
    ATTR32_VS        ( VFWREDOSUM_VS,  VFWREDOSUM_VS, RVANYV, "vfwredosum",    "|110011|.|.....|.....|001|.....|1010111|"),
    ATTR32_WV        (     VFWADD_WV,      VFWADD_WV, RVANYV, "vfwadd",        "|110100|.|.....|.....|001|.....|1010111|"),
    ATTR32_WV        (     VFWSUB_WV,      VFWSUB_WV, RVANYV, "vfwsub",        "|110110|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (     VFWMUL_VV,      VFWMUL_VV, RVANYV, "vfwmul",        "|111000|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (      VFDOT_VV,       VFDOT_VV, RVANYV, "vfdot",         "|111001|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (    VFWMACC_VV,     VFWMACC_VV, RVANYV, "vfwmacc",       "|111100|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (   VFWNMACC_VV,    VFWNMACC_VV, RVANYV, "vfwnmacc",      "|111101|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (    VFWMSAC_VV,     VFWMSAC_VV, RVANYV, "vfwmsac",       "|111110|.|.....|.....|001|.....|1010111|"),
    ATTR32_VV        (   VFWNMSAC_VV,    VFWNMSAC_VV, RVANYV, "vfwnmsac",      "|111111|.|.....|.....|001|.....|1010111|"),

    // V-extension MVV-type instructions                                        |funct6|m|  vs2|  vs1|MVV|  vs3| opcode|
    ATTR32_VV        (      VWADD_VV,       VWADD_VV, RVANYV, "vwadd",         "|110001|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (     VWADDU_VV,      VWADDU_VV, RVANYV, "vwaddu",        "|110000|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (      VWSUB_VV,       VWSUB_VV, RVANYV, "vwsub",         "|110011|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (     VWSUBU_VV,      VWSUBU_VV, RVANYV, "vwsubu",        "|110010|.|.....|.....|010|.....|1010111|"),
    ATTR32_WV        (      VWADD_WV,       VWADD_WV, RVANYV, "vwadd",         "|110101|.|.....|.....|010|.....|1010111|"),
    ATTR32_WV        (     VWADDU_WV,      VWADDU_WV, RVANYV, "vwaddu",        "|110100|.|.....|.....|010|.....|1010111|"),
    ATTR32_WV        (      VWSUB_WV,       VWSUB_WV, RVANYV, "vwsub",         "|110111|.|.....|.....|010|.....|1010111|"),
    ATTR32_WV        (     VWSUBU_WV,      VWSUBU_WV, RVANYV, "vwsubu",        "|110110|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (       VMUL_VV,        VMUL_VV, RVANYV, "vmul",          "|100101|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (      VMULH_VV,       VMULH_VV, RVANYV, "vmulh",         "|100111|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (     VMULHU_VV,      VMULHU_VV, RVANYV, "vmulhu",        "|100100|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (    VMULHSU_VV,     VMULHSU_VV, RVANYV, "vmulhsu",       "|100110|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (      VWMUL_VV,       VWMUL_VV, RVANYV, "vwmul",         "|111011|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (     VWMULU_VV,      VWMULU_VV, RVANYV, "vwmulu",        "|111000|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (    VWMULSU_VV,     VWMULSU_VV, RVANYV, "vwmulsu",       "|111010|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (      VMACC_VV,       VMACC_VV, RVANYV, "vmacc",         "|101101|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (      VMSAC_VV,       VMSAC_VV, RVANYV, "vmsac",         "|101111|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (      VMADD_VV,       VMADD_VV, RVANYV, "vmadd",         "|101001|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (      VMSUB_VV,       VMSUB_VV, RVANYV, "vmsub",         "|101011|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (    VWMACCU_VV,     VWMACCU_VV, RVANYV, "vwmaccu",       "|111100|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (     VWMACC_VV,      VWMACC_VV, RVANYV, "vwmacc",        "|111101|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (    VWMSACU_VV,     VWMSACU_VV, RVANYV, "vwmsacu",       "|111110|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (     VWMSAC_VV,      VWMSAC_VV, RVANYV, "vwmsac",        "|111111|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (      VDIVU_VV,       VDIVU_VV, RVANYV, "vdivu",         "|100000|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (       VDIV_VV,        VDIV_VV, RVANYV, "vdiv",          "|100001|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (      VREMU_VV,       VREMU_VV, RVANYV, "vremu",         "|100010|.|.....|.....|010|.....|1010111|"),
    ATTR32_VV        (       VREM_VV,        VREM_VV, RVANYV, "vrem",          "|100011|.|.....|.....|010|.....|1010111|"),
    ...
    ATTR32_MV        (      VMIOTA_M,       VMIOTA_M, RVANYV, "vmiota",        "|010110|.|.....|10000|010|.....|1010111|"),
    ...
    ATTR32_VI        (       VADC_VI,        VADC_VI, RVANYV, "vadc",          "|010000|1|.....|.....|011|.....|1010111|"),
    ATTR32_VI        (    VMERGEM_VI,      VMERGE_VI, RVANYV, "vmerge",        "|010111|0|.....|.....|011|.....|1010111|"),
    ATTR32_VI        (    VMERGE0_VI,      VMERGE_VI, RVANYV, "vmerge",        "|010111|1|00000|.....|011|.....|1010111|"),
    ATTR32_VI        (       VSEQ_VI,        VSEQ_VI, RVANYV, "vseq",          "|011000|.|.....|.....|011|.....|1010111|"),
    ATTR32_VI        (       VSNE_VI,        VSNE_VI, RVANYV, "vsne",          "|011001|.|.....|.....|011|.....|1010111|"),
    ATTR32_VI        (      VSLEU_VI,       VSLEU_VI, RVANYV, "vsleu",         "|011100|.|.....|.....|011|.....|1010111|"),
    ATTR32_VI        (       VSLE_VI,        VSLE_VI, RVANYV, "vsle",          "|011101|.|.....|.....|011|.....|1010111|"),
    ATTR32_VI        (      VSGTU_VI,       VSGTU_VI, RVANYV, "vsgtu",         "|011110|.|.....|.....|011|.....|1010111|"),
    ATTR32_VI        (       VSGT_VI,        VSGT_VI, RVANYV, "vsgt",          "|011111|.|.....|.....|011|.....|1010111|"),
    ...
    ATTR32_VX        (       VADD_VX,        VADD_VX, RVANYV, "vadd",          "|000000|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSUB_VX,        VSUB_VX, RVANYV, "vsub",          "|000010|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VRSUB_VX,       VRSUB_VX, RVANYV, "vrsub",         "|000011|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VMINU_VX,       VMINU_VX, RVANYV, "vminu",         "|000100|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VMIN_VX,        VMIN_VX, RVANYV, "vmin",          "|000101|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VMAXU_VX,       VMAXU_VX, RVANYV, "vmaxu",         "|000110|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VMAX_VX,        VMAX_VX, RVANYV, "vmax",          "|000111|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VAND_VX,        VAND_VX, RVANYV, "vand",          "|001001|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (        VOR_VX,         VOR_VX, RVANYV, "vor",           "|001010|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VXOR_VX,        VXOR_VX, RVANYV, "vxor",          "|001011|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (   VRGATHER_VX,    VRGATHER_VX, RVANYV, "vrgather",      "|001100|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (   VSLIDEUP_VX,    VSLIDEUP_VX, RVANYV, "vslideup",      "|001110|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        ( VSLIDEDOWN_VX,  VSLIDEDOWN_VX, RVANYV, "vslidedown",    "|001111|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VADC_VX,        VADC_VX, RVANYV, "vadc",          "|010000|1|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSBC_VX,        VSBC_VX, RVANYV, "vsbc",          "|010010|1|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (    VMERGEM_VX,      VMERGE_VX, RVANYV, "vmerge",        "|010111|0|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (    VMERGE0_VX,      VMERGE_VX, RVANYV, "vmerge",        "|010111|1|00000|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSEQ_VX,        VSEQ_VX, RVANYV, "vseq",          "|011000|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSNE_VX,        VSNE_VX, RVANYV, "vsne",          "|011001|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VSLTU_VX,       VSLTU_VX, RVANYV, "vsltu",         "|011010|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSLT_VX,        VSLT_VX, RVANYV, "vslt",          "|011011|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VSLEU_VX,       VSLEU_VX, RVANYV, "vsleu",         "|011100|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSLE_VX,        VSLE_VX, RVANYV, "vsle",          "|011101|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VSGTU_VX,       VSGTU_VX, RVANYV, "vsgtu",         "|011110|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSGT_VX,        VSGT_VX, RVANYV, "vsgt",          "|011111|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (     VSADDU_VX,      VSADDU_VX, RVANYV, "vsaddu",        "|100000|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VSADD_VX,       VSADD_VX, RVANYV, "vsadd",         "|100001|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (     VSSUBU_VX,      VSSUBU_VX, RVANYV, "vssubu",        "|100010|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VSSUB_VX,       VSSUB_VX, RVANYV, "vssub",         "|100011|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VAADD_VX,       VAADD_VX, RVANYV, "vaadd",         "|100100|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSLL_VX,        VSLL_VX, RVANYV, "vsll",          "|100101|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VASUB_VX,       VASUB_VX, RVANYV, "vasub",         "|100110|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VSMUL_VX,       VSMUL_VX, RVANYV, "vsmul",         "|100111|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSRL_VX,        VSRL_VX, RVANYV, "vsrl",          "|101000|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (       VSRA_VX,        VSRA_VX, RVANYV, "vsra",          "|101001|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VSSRL_VX,       VSSRL_VX, RVANYV, "vssrl",         "|101010|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VSSRA_VX,       VSSRA_VX, RVANYV, "vssra",         "|101011|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VNSRL_VX,       VNSRL_VX, RVANYV, "vnsrl",         "|101100|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (      VNSRA_VX,       VNSRA_VX, RVANYV, "vnsra",         "|101101|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (    VNCLIPU_VX,     VNCLIPU_VX, RVANYV, "vnclipu",       "|101110|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (     VNCLIP_VX,      VNCLIP_VX, RVANYV, "vnclip",        "|101111|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (   VWSMACCU_VX,    VWSMACCU_VX, RVANYV, "vwsmaccu",      "|111100|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (    VWSMACC_VX,     VWSMACC_VX, RVANYV, "vwsmacc",       "|111101|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (   VWSMSCCU_VX,    VWSMSCCU_VX, RVANYV, "vwsmsccu",      "|111110|.|.....|.....|100|.....|1010111|"),
    ATTR32_VX        (    VWSMSCC_VX,     VWSMSCC_VX, RVANYV, "vwsmscc",       "|111111|.|.....|.....|100|.....|1010111|"),

    // V-extension FVF-type instructions                                        |funct6|m|  vs2|  fs1|FVF|  vs3| opcode|
    ATTR32_VF        (      VFADD_VF,       VFADD_VF, RVANYV, "vfadd",         "|000000|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (      VFSUB_VF,       VFSUB_VF, RVANYV, "vfsub",         "|000010|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (      VFMIN_VF,       VFMIN_VF, RVANYV, "vfmin",         "|000100|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (      VFMAX_VF,       VFMAX_VF, RVANYV, "vfmax",         "|000110|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (     VFSGNJ_VF,      VFSGNJ_VF, RVANYV, "vfsgnj",        "|001000|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (    VFSGNJN_VF,     VFSGNJN_VF, RVANYV, "vfsgnjn",       "|001001|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (    VFSGNJX_VF,     VFSGNJX_VF, RVANYV, "vfsgnjx",       "|001010|.|.....|.....|101|.....|1010111|"),
    ATTR32_VFMV_S_F  (      VFMV_S_F,       VFMV_S_F, RVANYV, "vfmv.s.f",      "|001101|.|00000|.....|101|.....|1010111|"),
    ATTR32_VF        (   VFMERGEM_VF,     VFMERGE_VF, RVANYV, "vfmerge",       "|010111|0|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (   VFMERGE0_VF,     VFMERGE_VF, RVANYV, "vfmerge",       "|010111|1|00000|.....|101|.....|1010111|"),
    ATTR32_VF        (       VFEQ_VF,        VFEQ_VF, RVANYV, "vfeq",          "|011000|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (      VFLTE_VF,       VFLTE_VF, RVANYV, "vflte",         "|011001|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (      VFORD_VF,       VFORD_VF, RVANYV, "vford",         "|011010|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (       VFLT_VF,        VFLT_VF, RVANYV, "vflt",          "|011011|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (       VFNE_VF,        VFNE_VF, RVANYV, "vfne",          "|011100|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (       VFGT_VF,        VFGT_VF, RVANYV, "vfgt",          "|011101|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (      VFGTE_VF,       VFGTE_VF, RVANYV, "vfgte",         "|011111|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (      VFDIV_VF,       VFDIV_VF, RVANYV, "vfdiv",         "|100000|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (     VFRDIV_VF,      VFRDIV_VF, RVANYV, "vfrdiv",        "|100001|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (      VFMUL_VF,       VFMUL_VF, RVANYV, "vfmul",         "|100100|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (     VFMADD_VF,      VFMADD_VF, RVANYV, "vfmadd",        "|101000|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (    VFNMADD_VF,     VFNMADD_VF, RVANYV, "vfnmadd",       "|101001|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (     VFMSUB_VF,      VFMSUB_VF, RVANYV, "vfmsub",        "|101010|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (    VFNMSUB_VF,     VFNMSUB_VF, RVANYV, "vfnmsub",       "|101011|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (     VFMACC_VF,      VFMACC_VF, RVANYV, "vfmacc",        "|101100|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (    VFNMACC_VF,     VFNMACC_VF, RVANYV, "vfnmacc",       "|101101|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (     VFMSAC_VF,      VFMSAC_VF, RVANYV, "vfmsac",        "|101110|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (    VFNMSAC_VF,     VFNMSAC_VF, RVANYV, "vfnmsac",       "|101111|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (     VFWADD_VF,      VFWADD_VF, RVANYV, "vfwadd",        "|110000|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (     VFWSUB_VF,      VFWSUB_VF, RVANYV, "vfwsub",        "|110010|.|.....|.....|101|.....|1010111|"),
    ATTR32_WF        (     VFWADD_WF,      VFWADD_WF, RVANYV, "vfwadd",        "|110100|.|.....|.....|101|.....|1010111|"),
    ATTR32_WF        (     VFWSUB_WF,      VFWSUB_WF, RVANYV, "vfwsub",        "|110110|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (     VFWMUL_VF,      VFWMUL_VF, RVANYV, "vfwmul",        "|111000|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (    VFWMACC_VF,     VFWMACC_VF, RVANYV, "vfwmacc",       "|111100|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (   VFWNMACC_VF,    VFWNMACC_VF, RVANYV, "vfwnmacc",      "|111101|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (    VFWMSAC_VF,     VFWMSAC_VF, RVANYV, "vfwmsac",       "|111110|.|.....|.....|101|.....|1010111|"),
    ATTR32_VF        (   VFWNMSAC_VF,    VFWNMSAC_VF, RVANYV, "vfwnmsac",      "|111111|.|.....|.....|101|.....|1010111|"),
    ...
    ATTR32_VX        (      VDIVU_VX,       VDIVU_VX, RVANYV, "vdivu",         "|100000|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (       VDIV_VX,        VDIV_VX, RVANYV, "vdiv",          "|100001|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (      VREMU_VX,       VREMU_VX, RVANYV, "vremu",         "|100010|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (       VREM_VX,        VREM_VX, RVANYV, "vrem",          "|100011|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (     VMULHU_VX,      VMULHU_VX, RVANYV, "vmulhu",        "|100100|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (       VMUL_VX,        VMUL_VX, RVANYV, "vmul",          "|100101|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (    VMULHSU_VX,     VMULHSU_VX, RVANYV, "vmulhsu",       "|100110|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (      VMULH_VX,       VMULH_VX, RVANYV, "vmulh",         "|100111|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (      VMADD_VX,       VMADD_VX, RVANYV, "vmadd",         "|101001|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (      VMSUB_VX,       VMSUB_VX, RVANYV, "vmsub",         "|101011|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (      VMACC_VX,       VMACC_VX, RVANYV, "vmacc",         "|101101|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (      VMSAC_VX,       VMSAC_VX, RVANYV, "vmsac",         "|101111|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (     VWADDU_VX,      VWADDU_VX, RVANYV, "vwaddu",        "|110000|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (      VWADD_VX,       VWADD_VX, RVANYV, "vwadd",         "|110001|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (     VWSUBU_VX,      VWSUBU_VX, RVANYV, "vwsubu",        "|110010|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (      VWSUB_VX,       VWSUB_VX, RVANYV, "vwsub",         "|110011|.|.....|.....|110|.....|1010111|"),
    ATTR32_WX        (     VWADDU_WX,      VWADDU_WX, RVANYV, "vwaddu",        "|110100|.|.....|.....|110|.....|1010111|"),
    ATTR32_WX        (      VWADD_WX,       VWADD_WX, RVANYV, "vwadd",         "|110101|.|.....|.....|110|.....|1010111|"),
    ATTR32_WX        (     VWSUBU_WX,      VWSUBU_WX, RVANYV, "vwsubu",        "|110110|.|.....|.....|110|.....|1010111|"),
    ATTR32_WX        (      VWSUB_WX,       VWSUB_WX, RVANYV, "vwsub",         "|110111|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (     VWMULU_VX,      VWMULU_VX, RVANYV, "vwmulu",        "|111000|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (    VWMULSU_VX,     VWMULSU_VX, RVANYV, "vwmulsu",       "|111010|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (      VWMUL_VX,       VWMUL_VX, RVANYV, "vwmul",         "|111011|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (    VWMACCU_VX,     VWMACCU_VX, RVANYV, "vwmaccu",       "|111100|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (     VWMACC_VX,      VWMACC_VX, RVANYV, "vwmacc",        "|111101|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (    VWMSACU_VX,     VWMSACU_VX, RVANYV, "vwmsacu",       "|111110|.|.....|.....|110|.....|1010111|"),
    ATTR32_VX        (     VWMSAC_VX,      VWMSAC_VX, RVANYV, "vwmsac",        "|111111|.|.....|.....|110|.....|1010111|"),
