...
Zbb
 ...
 & \sout{\tt sext.h, sext.b       } & {\tt                           } \\
 & {\tt                           } & \sout{\tt add[i]wu, subwu      } \\
...
\sout{Zbb}
 ...
 & {\tt orc.b, orc16              } & {\tt                           } \\
\end{tabular}
\caption{Old {\tt Zbb} extension instruction listing. \it Just for reference during editing. Will be removed soon.}
\end{center}
\label{oldzbb}
\end{table}
