...
\hline
Notes:\\
\multicolumn{3}{l}{- * means the sub-extensions (including the constituent instruction mnemonics, opcodes and function) have been approved and are frozen. } \\
\end{tabular}
...
On RV64, {\tt zext.w} ({\tt add.uw}) is commonly used to zero-extend unsigned
words.  For RV128, {\tt zext.d} is expected to be similarly common, and might
map to a hypothetical {\tt add.ud} instruction.
