...
\begin{tikzpicture}
 ...
 \node (bmatxor) [right=3.5cm of bext.west,anchor=north west] { \texttt{bmat[x]or} };
 ...
 \node (cmov) [right=3.5cm of crc32.west,anchor=west] { \texttt{cmov, cmix} };
...
\begin{verbatim}
  ...
  eswap.w rd, rs    ->   bswap rd, rs; c.srai rd, (XLEN-32)
  eswap.d rd, rs    ->   bswap rd, rs; c.srai rd, (XLEN-64)

  eswapu.b rd, rs   ->   bswap rd, rs; c.srli rd, (XLEN-8)
  eswapu.h rd, rs   ->   bswap rd, rs; c.srli rd, (XLEN-16)
  eswapu.w rd, rs   ->   bswap rd, rs; c.srli rd, (XLEN-32)
  eswapu.d rd, rs   ->   bswap rd, rs; c.srli rd, (XLEN-64)

  (or simply bswap/bswapw/bswapd if applicable)
\end{verbatim}
\end{minipage}
