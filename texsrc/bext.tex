...
\section{Future 64-bit instruction for bit-field extract and place}
...
and {\tt bfxp} zero-extends. When {\tt src\_len == 0} then {\tt bfxp} sets bits
in the output and {\tt bfxpu} clears bits. When {\tt src\_len}$+${\tt src\_off} $>$ XLEN
