...
\subsection{Add/sub/shift with prefix zero-extend ({\tt adduw}, {\tt subuw}, {\tt ssliuw})}
...
{\tt slliuw} is identlical to {\tt slli}, except that bits XLEN-1:32 of the
{\tt rs1} argument are cleared before the shift.

{\tt adduw} and {\tt subuw} are identlical to {\tt add} and {\tt sub}, except
