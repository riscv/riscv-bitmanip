...
Rotate shift right by $k$ is simply addition modulo XLEN.
$$ i'_\mathrm{rot} := i + k \mod \mathrm{XLEN} $$
...
perferm a certain sub-set of bit address permutations, but a sequence of 5 {\tt
shfl}/{\tt unshfl} instructions can perform any of the 120 such permutations on
RV32, and a sequence of 6 {\tt shfl}/{\tt unshfl} instructions can perform any
...
Sequences of {\tt rot}, {\tt grev}, and {\tt [un]shfl} instructions can
