...
\begin{tikzpicture}
 ...
 \node (ssliuw) [below=0.5cm of adduw.west,anchor=west] { \texttt{slliu.w} };
 ...
 \node (andn) [below=1.0cm of ssliuw.west,anchor=west] { \texttt{andn, orn} };
 ...
 \begin{scope}[on background layer]
   ...
   \draw [draw=black, fill=gray, opacity=0.2] ($ (clz.north west) + (0,+0.2cm) $) |- ($ (clmul.south west) + (3.15cm,-0.2cm) $)
     |- ($ (bext.north west) + (6.0cm,0) $) |- ($ (clz.north west) + (0,+0.2cm) $);
