...
\begin{tikzpicture}
 ...
 \node (adduw) [below=0.5cm of addwu.west,anchor=west] { \texttt{addu.w} };
...
{\tt addu.w} is identical to {\tt add}, except
that bits XLEN-1:32 of the {\tt rs2} argument are cleared before the add.
