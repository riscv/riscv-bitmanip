...
pseudo-instructions, except the prefix {\tt orc} is used instead of {\tt rev}.
...
Pending changes for v0.91 of the RISC-V Bitmanip Spec ({\tt +} for addition,
{\tt -} for removal):
...
|---------------------------------------------------------------|
|  0100100    |   rs2   |   rs1   | 100 |    rd   |   0110011   |  + BFP
|---------------------------------------------------------------|
\end{verbatim}
\end{minipage}
