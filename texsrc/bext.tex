...
\begin{tikzpicture}
 ...
 \node (bfp) [right=3.5cm of crc32c.west,anchor=west] { \texttt{bfp} };
 ...
 \begin{scope}[on background layer]
   ...
   \node (bt) at ($ (bfp.west) + (3.0cm,0) $) [right, text=gray] { \textbf{Zbf} };
   \draw [draw=black, fill=gray, opacity=0.1] ($ (bfp.north west) + (-0.2cm,0) $) rectangle ($ (bfp.south west) + (3.0cm,0) $);
 \end{scope}
\end{tikzpicture}
\end{center}
