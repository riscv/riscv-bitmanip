...
\begin{tikzpicture}
 ...
 \node (min) [below=0.5cm of pcnt.west,anchor=west] { \texttt{min[u], max[u]} };
 ...
 \node (bitmatxor) [right=3.5cm of crc32.west,anchor=west] { \texttt{bmat[x]or} };
 \node (bitmatflip) [below=0.5cm of bitmatxor.west,anchor=west] { \texttt{bitmatflip} };
...
RVC encoding space respectively. Preliminary experiments have show that NOT
...
\subsection{Bit-field extract pseudo instruction ({\tt bfext})}
\label{bfext}
...
|  0000101    |   rs2   |   rs1   | 000 |    rd   |   0110011   |  BEXT
|  0000101    |   rs2   |   rs1   | 001 |    rd   |   0110011   |  BDEP
...
|  0000100    |   rs2   |   rs1   | 000 |    rd   |   0110011   |  MIN
|  0000100    |   rs2   |   rs1   | 001 |    rd   |   0110011   |  MAX
|  0000100    |   rs2   |   rs1   | 010 |    rd   |   0110011   |  MINU
|  0000100    |   rs2   |   rs1   | 011 |    rd   |   0110011   |  MAXU
|  0000100    |   rs2   |   rs1   | 100 |    rd   |   0110011   |  CLMUL
|  0000100    |   rs2   |   rs1   | 101 |    rd   |   0110011   |  CLMULH
...
|  0000101    |   rs2   |   rs1   | 000 |    rd   |   0111011   |  BEXTW
|  0000101    |   rs2   |   rs1   | 001 |    rd   |   0111011   |  BDEPW
|  0000100    |   rs2   |   rs1   | 000 |    rd   |   0111011   |  MINW
|  0000100    |   rs2   |   rs1   | 001 |    rd   |   0111011   |  MAXW
|  0000100    |   rs2   |   rs1   | 010 |    rd   |   0111011   |  MINUW
|  0000100    |   rs2   |   rs1   | 011 |    rd   |   0111011   |  MAXUW
|  0000100    |   rs2   |   rs1   | 100 |    rd   |   0111011   |  CLMULW
|---------------------------------------------------------------|
\end{verbatim}
