...
by combining {\tt not} with the base ALU operation. Only and-with-complement
...
There is no {\tt fsli} instruction, as it can be easily emulated with {\tt
fsri} by taking the two's complement of the shift amount. The {\tt sllu.w}
instruction occupies the encoding slot that would be occupied by {\tt fsli}.
...
|  00000  |1|0|   imm   |   rs1   | 001 |    rd   |   0011011   |  SLLIU.W
|---------------------------------------------------------------|
