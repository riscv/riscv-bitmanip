...
The entry {\tt XBitmanip} is just the total of {\tt simplegrev} $+$ {\tt
simplegzip} $+$ {\tt simplebitcnt} $+$ {\tt smartbextdep}. Not included is the
...
In the following graph the height of 1 LUT $\hat{=}$ 2.86 Gates, 1 FF $\hat{=}$ 5.00 Gates.
...
\fill[white] (3.500,0) rectangle (3.750,0.219);
\fill[white] (3.750,0) rectangle (4.000,0.261);
\fill[white] (3.500,0) rectangle (4.000,-0.156);
\draw[pattern=north west lines, pattern color=blue] (3.500,0) rectangle (3.750,0.219);
\draw[pattern=crosshatch dots, pattern color=green] (3.750,0) rectangle (4.000,0.261);
...
\fill[white] (5.500,0) rectangle (5.750,0.457);
\fill[white] (5.750,0) rectangle (6.000,0.317);
\fill[white] (5.500,0) rectangle (6.000,-0.022);
\draw[pattern=north west lines, pattern color=blue] (5.500,0) rectangle (5.750,0.457);
...
\fill[white] (6.500,0) rectangle (6.750,0.238);
\fill[white] (6.750,0) rectangle (7.000,0.261);
\fill[white] (6.500,0) rectangle (7.000,-0.119);
\draw[pattern=north west lines, pattern color=blue] (6.500,0) rectangle (6.750,0.238);
...
\fill[white] (7.500,0) rectangle (7.750,0.584);
\fill[white] (7.750,0) rectangle (8.000,0.659);
\fill[white] (7.500,0) rectangle (8.000,-0.486);
\draw[pattern=north west lines, pattern color=blue] (7.500,0) rectangle (7.750,0.584);
\draw[pattern=crosshatch dots, pattern color=green] (7.750,0) rectangle (8.000,0.659);
...
\fill[white] (8.750,0) rectangle (9.000,1.107);
\fill[white] (8.500,0) rectangle (9.000,-0.119);
\draw[pattern=north west lines, pattern color=blue] (8.500,0) rectangle (8.750,1.145);
\draw[pattern=crosshatch dots, pattern color=green] (8.750,0) rectangle (9.000,1.107);
...
\fill[white] (9.500,0) rectangle (9.750,2.219);
\fill[white] (9.750,0) rectangle (10.000,2.100);
\fill[white] (9.500,0) rectangle (10.000,-0.379);
\draw[pattern=north west lines, pattern color=blue] (9.500,0) rectangle (9.750,2.219);
\draw[pattern=crosshatch dots, pattern color=green] (9.750,0) rectangle (10.000,2.100);
\draw[pattern=crosshatch, pattern color=magenta] (9.500,0) rectangle (10.000,-0.379);
\draw (10.550,0) node[above right,rotate=90] {\tiny\tt rocketmuldiv};
\fill[white] (10.500,0) rectangle (10.750,3.749);
\fill[white] (10.750,0) rectangle (11.000,3.043);
\fill[white] (10.500,0) rectangle (11.000,-0.445);
\draw[pattern=north west lines, pattern color=blue] (10.500,0) rectangle (10.750,3.749);
