...
In terms of binary polynomial arithmetic those instructions perform the
operation
...
$\{a, b\}$ denoting bit concatenation.
(For example for CRC32 $\{\texttt{1}, P'\} = \texttt{0x1\_04C1\_1DB7}$
