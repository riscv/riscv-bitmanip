...
int main()
{
  ...
  printf(" 0x%08lx %s\n", (long)test_zbb_result, test_zbb_result == 0xec0da0fa ? "OK" : "ERROR");
  if (test_zbb_result != 0xec0da0fa) return 1;
  printf("test_zbs");
  fflush(stdout);
  long test_zbs_result = test_zbs(args, 128);
  printf(" 0x%08lx %s\n", (long)test_zbs_result, test_zbs_result == 0x075bcd15 ? "OK" : "ERROR");
  if (test_zbs_result != 0x075bcd15) return 1;
  printf("test_zbp");
  fflush(stdout);
  long test_zbp_result = test_zbp(args, 128);
  printf(" 0x%08lx %s\n", (long)test_zbp_result, test_zbp_result == 0x075bcd15 ? "OK" : "ERROR");
  if (test_zbp_result != 0x075bcd15) return 1;
  printf("test_zbe");
  fflush(stdout);
  long test_zbe_result = test_zbe(args, 128);
  printf(" 0x%08lx %s\n", (long)test_zbe_result, test_zbe_result == 0x075bcd15 ? "OK" : "ERROR");
  if (test_zbe_result != 0x075bcd15) return 1;
  printf("test_zbc");
  fflush(stdout);
  long test_zbc_result = test_zbc(args, 128);
  printf(" 0x%08lx %s\n", (long)test_zbc_result, test_zbc_result == 0x075bcd15 ? "OK" : "ERROR");
  if (test_zbc_result != 0x075bcd15) return 1;
  printf("test_zbr");
  fflush(stdout);
  ...
  printf(" 0x%08lx %s\n", (long)test_zbm_result, test_zbm_result == 0x075bcd15 ? "OK" : "ERROR");
  if (test_zbm_result != 0x075bcd15) return 1;
  printf("test_zbt");
  fflush(stdout);
  long test_zbt_result = test_zbt(args, 128);
  printf(" 0x%08lx %s\n", (long)test_zbt_result, test_zbt_result == 0x075bcd15 ? "OK" : "ERROR");
  if (test_zbt_result != 0x075bcd15) return 1;
