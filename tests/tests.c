...
int main()
{
  printf("test_zbb");
  fflush(stdout);
  uint64_t test_zbb_result = test_zbb(args, 128);
  printf(" 0x%016llx %s\n", (long long)test_zbb_result, test_zbb_result == 0x00000000ec0da0fa ? "OK" : "ERROR");
  if (test_zbb_result != 0x00000000ec0da0fa) return 1;
  printf("test_zbs");
  fflush(stdout);
  uint64_t test_zbs_result = test_zbs(args, 128);
  printf(" 0x%016llx %s\n", (long long)test_zbs_result, test_zbs_result == 0x00000000075bcd15 ? "OK" : "ERROR");
  if (test_zbs_result != 0x00000000075bcd15) return 1;
  printf("test_zbp");
  fflush(stdout);
  uint64_t test_zbp_result = test_zbp(args, 128);
  printf(" 0x%016llx %s\n", (long long)test_zbp_result, test_zbp_result == 0x00000000075bcd15 ? "OK" : "ERROR");
  if (test_zbp_result != 0x00000000075bcd15) return 1;
  printf("test_zbe");
  fflush(stdout);
  uint64_t test_zbe_result = test_zbe(args, 128);
  printf(" 0x%016llx %s\n", (long long)test_zbe_result, test_zbe_result == 0x00000000075bcd15 ? "OK" : "ERROR");
  if (test_zbe_result != 0x00000000075bcd15) return 1;
  printf("test_zbc");
  fflush(stdout);
  uint64_t test_zbc_result = test_zbc(args, 128);
  printf(" 0x%016llx %s\n", (long long)test_zbc_result, test_zbc_result == 0x00000000075bcd15 ? "OK" : "ERROR");
  if (test_zbc_result != 0x00000000075bcd15) return 1;
  printf("test_zbr");
  fflush(stdout);
  uint64_t test_zbr_result = test_zbr(args, 128);
  printf(" 0x%016llx %s\n", (long long)test_zbr_result, test_zbr_result == 0x00000000075bcd15 ? "OK" : "ERROR");
  if (test_zbr_result != 0x00000000075bcd15) return 1;
  printf("test_zbm");
  fflush(stdout);
  uint64_t test_zbm_result = test_zbm(args, 128);
  printf(" 0x%016llx %s\n", (long long)test_zbm_result, test_zbm_result == 0x00000000075bcd15 ? "OK" : "ERROR");
  if (test_zbm_result != 0x00000000075bcd15) return 1;
  printf("test_zbt");
  fflush(stdout);
  uint64_t test_zbt_result = test_zbt(args, 128);
  printf(" 0x%016llx %s\n", (long long)test_zbt_result, test_zbt_result == 0x00000000075bcd15 ? "OK" : "ERROR");
  if (test_zbt_result != 0x00000000075bcd15) return 1;
