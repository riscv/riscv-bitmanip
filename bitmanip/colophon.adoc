...
|xref:insns/bclri.adoc[Single-bit clear (Immediate)]
|
|
|
|&#88;
...
|xref:insns/bclriw.adoc[Single-bit clear, word (Immediate)]
|
|
|
|&#88;
...
|xref:insns/bextw.adoc[Single-Bit Extract, word (Immediate)]
|
|
|
|&#88;
...
|xref:insns/binviw.adoc[Single-Bit Invert, word (Immediate)]
|
|
|
|&#88;
...
|xref:insns/bsetiw.adoc[Single-Bit Set, word (Immediate)]
|
|
|
|&#88;
...
|xref:insns/bsetw.adoc[Single-Bit Set, word (Immediate)]
|
|
|
|&#88;
